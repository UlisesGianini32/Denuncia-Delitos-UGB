...
Route::post('/lot/update/{id}', [LotController::class, 'update']);  // CORREGIDO
Route::post('/lot/delete/{id}', [LotController::class, 'delete']);

Route::get('/product', [ProductController::class, 'list']);
Route::get('/product/{id}', [ProductController::class, 'item']);
Route::post('/product/create', [ProductController::class, 'create']);
Route::post('/product/update/{id}', [ProductController::class, 'update']);  // CORREGIDO
...
Route::post('/employee/update/{id}', [EmployeeController::class, 'update']);  // CORREGIDO
...
Route::post('/entry/update/{id}', [EntryController::class, 'update']);  // CORREGIDO
